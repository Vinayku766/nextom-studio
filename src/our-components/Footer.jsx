...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-black backdrop-blur-md text-white py-3">
   <div className="mx-auto px-6 text-center space-y-5 flex justify-between items-center flex-col sm:flex-row max-w-7xl bg-white/5 backdrop-blur-md border border-white/10 rounded-xl shadow-lg py-6">
  {/* Brand */}
